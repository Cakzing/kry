//ೋ❀❀ೋ═══[SUBSCRIBE HERMAN CHANEL]═══ೋ❀❀ೋ//
//ೋ❀❀ೋ═══[SUBSCRIBE HERMAN CHANEL]═══ೋ❀❀ೋ//
//ೋ❀❀ೋ═══[SUBSCRIBE HERMAN CHANEL]═══ೋ❀❀ೋ//
//ೋ❀❀ೋ═══[SUBSCRIBE HERMAN CHANEL]═══ೋ❀❀ೋ//
//ೋ❀❀ೋ═══[SUBSCRIBE HERMAN CHANEL]═══ೋ❀❀ೋ//
...
const Mfake = fs.readFileSync ('./media/herman2.jpg')
const Mthumb = fs.readFileSync('./media/herman2.jpg')
...
let fakeimage = fs.readFileSync("./media/herman2.jpg")
...
module.exports = herman = async (herman, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = herman.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© Kry Bot","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const reply = (teks) => {
	      herman.sendMessage(from, teks, text, {quoted:mek, thumbnail: fakeimage})
        }
        const sendMess = (hehe, teks) => {
           herman.sendMessage(hehe, teks, text)
        }
        const mentions = (teks, memberr, id) => {
           (id == null || id == undefined || id == false) ? herman.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/herman2.jpg')}, extendedText, { sendEphemeral: true, contextInfo: { "mentionedJid": memberr } }) : herman.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/herman2.jpg')}, extendedText, { sendEphemeral: true, quoted: mek, contextInfo: { "mentionedJid": memberr } })
        }
        const sendText = (from, text) => {
           herman.sendMessage(from, text, MessageType.text)
        }
        const textImg = (teks) => {
           return herman.sendMessage(from, teks, text, {quoted: mek, thumbnail: fs.readFileSync('./media/herman2.jpg')})
        }
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/herman3.jpg')
        }}}
       const math = (teks) => {
       ...
       const sendKontak = (from, nomor, nama, org = "") => {
	       ...
	       herman.sendMessage(from, {displayname: nama, vcard: vcard}, MessageType.contact, {quoted: mek})
}
      const hideTag = async function(from, text){
	       ...
	       herman.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/herman3.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
      const sendWebp = async(to, url) => {
           ...
           herman.sendMessage(from, fs.readFileSync(asw), sticker, {sendEphemeral:true, quoted:mek})
           fs.unlinkSync(asw)
});
});
});
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           herman.sendMessage(to, media, type, {quoted: mek, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftext = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `*Hai ${pushname}👋*\n  ${moment().utcOffset('+0700').format('HH:mm:ss')} ${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync('./media/herman3.jpg')}}}
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/herman3.jpg`)},"title": `© Zero YT7`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Zero YT7", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Zero YT7","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
function banChat() {
    if (banChats == true) {
      ...
      // GAME 
             game.cekWaktuFam(herman, family100)
        ...
        if (game.isfam(from, family100)) {
            ...
            if (anjuy.length < 1){
                herman.sendMessage(from, `Semua jawaban sudah tertebak\nKirim *${prefix}family100* untuk bermain lagi`, text)
...
➸ *Sejak* : ${getTime}`
      mentions(cptl, x, true)
        ...
        //auto vn 
        await herman.updatePresence(from, Presence.recording)
...
╰┬———╯          │ ∴°·
 ☆\ˍˍ\_ˍ|—|ˍˍ/ˍˍ/∴☆.`
               ...
               imageMsg = (await herman.prepareMessageMedia(fs.readFileSync(`./media/herman3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/herman3.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Kry Bot', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}

               prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: troli})
              herman.relayWAMessage(prep)
                break
        case 'selamat':
        man =`⛅ ☁ ☁  ☁  🚁   ✈
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               imageMsg = (await herman.prepareMessageMedia(fs.readFileSync(`./media/herman4.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/herman3.jpg`)})).imageMessage
...
[ ${args[0]} ] Ketik Y/N untuk menerima atau menolak permainan`
               ...
               herman.sendMessage(from, starGame, text, {quoted: mek, contextInfo: { mentionedJid: [sender, args[0].replace("@", "") + "@s.whatsapp.net"],}})
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
       ...
       case 'tebakanime':
              ...
              herman.sendMessage(from, ini_buffer, image, { quoted: mek, caption: '*+* ```Tebak Anime```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s' }).then(() => {
       ...
       case 'tebaklagu':
              ...
              reply('*+* ```Tebak Lagu```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s')
              herman.sendMessage(from, ini_buffer, audio, {quoted: mek}).then(() => {
       ...
       case 'tebaktebakan':
              ...
              herman.sendMessage(from, '*+* ```Tebak Tebakan```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'kuismath':
              ...
              jawaban = get_result.jawaban
              ini_buffer = await getBuffer(ini_image)
              herman.sendMessage(from, ini_buffer, image, { quoted: mek, caption: '*+* ```Kuis Matematika```\n\nSilahkan jawab soal berikut ini\n\n• *Waktu* : 50s' }).then(() => {
       ...
       case 'tebakgambar':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              ini_buffer = await getBuffer(ini_image)
              herman.sendMessage(from, ini_buffer, image, { quoted: mek, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+kisi_kisi+'\nWaktu : 30s' }).then(() => {
       ...
       case 'siapaaku':
              ...
              herman.sendMessage(from, '*+* ```Tebak Siapakah Aku```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'tebakkata':
              ...
              herman.sendMessage(from, '*+* ```Tebak Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'tebaklirik':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              herman.sendMessage(from, '*+* ```Tebak Lirik```\n\n• *Soal* :'+pertanyaan+'\n• *Kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
      ...
      case 'tebakjenaka':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              herman.sendMessage(from, '*+* ```Tebak Jenaka```\n\n• *Soal* :'+pertanyaan+'\n• *Kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'kimiakuis':
              ...
              herman.sendMessage(from, '*+* ```Tebak Kimia```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'tebakbendera':
              ...
              herman.sendMessage(from, '*+* ```Tebak Bendera```\n\n• *Bendera* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'susunkata':
              ...
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
              herman.sendMessage(from, '*+* ```Susun Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'asahotak':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
              herman.sendMessage(from, '*+* ```Asah Otak```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'caklontong':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              herman.sendMessage(from, '*+* ```Caklontong```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/kynNYTh/herman2.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot © Kry Bot*
*1 Hari :* 2K
*1 Minggu :* 10K
...
*Dengan cara, Ketik* ${prefix}owner *Ya!*`
              herman.sendMessage(from, await getBuffer(gopeynya), image, {quoted: mek, caption: teksnya })
              break             
//------------------< bayar menu >-------------------  
case 'bayar':
gopeynya = 'https://i.ibb.co/kynNYTh/herman2.jpg'
...
*Ovo :* 083146208804
*[ © Kry Bot ]*`
        herman.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
*• ${prefix}nekopoisearch*`
              herman.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftext, caption: teksnya })
              break
case 'buttonown':
              gopeynya = 'https://i.ibb.co/kynNYTh/herman2.jpg'
              teksnya = `*「OWNER MENU」*
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
        ...
        case 'google':
              ...
              vars +=  `\n═════════════════\n\n*Judul:* ${results[i].title}\n\n*Deskripsi:* ${results[i].snippet}\n\n*Link:* ${results[i].link}\n\n`
               ...
               herman.sendMessage(from, ss, image, {caption: vars, quoted : mek})
               }).catch(e => {
               console.log(e)
               reply(`${e}`)
})
...
case 'tiktok':
              ...
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              herman.relayWAMessage(prep)
              break
      case 'ttaudio': 
      case 'tiktokmusic': 
      case 'tiktokaudio':
             ...
             herman.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: mek })
             break
      case 'fb':
      case 'facebook':
             if (!q) return
      ...
      case 'ssweb':
             ...
             await herman.sendMessage(from, ini_buffer, image, { quoted: mek })
             break
       case 'nhentaipdf':
             if (!isPremium) return reply(mess.only.premium)
             ...
             herman.sendMessage(from, ini_image, image, { caption: teks, quoted: mek })
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=${setting.lolkey}`)
             pdf = await getBuffer(anu.result)
             herman.sendMessage(from, pdf, document, { quoted: mek, mimetype: Mimetype.pdf, filename: `${get_result.title_romaji}.pdf`, thumbnail: ini_image })
             } catch (e) {
             console.log(e)
             reply(String(e))
}
       ...
       case 'doujindesu':
             ...
             herman.sendMessage(from, buffer, image, {caption: xixixai, quoted: mek})
             } catch (e) {
             console.log(e)
             reply(String(e))
}
      ...
      case 'kusonime':
       ...
       case 'wallnime':
              ...
              herman.sendMessage(from, gambar, image, { quoted: mek, thumbnail: Buffer.alloc(0) })
})
              break
       ...
       case 'storyanime':
              ...
              herman.sendMessage(from, buffer, video, { quoted: mek })
              break
       case 'nekopoi3d':
       case '3dnekopoi':
       case '3dnekopoilast':
        ...
        case 'otakuongoing':              
               ...
               herman.sendMessage(from, buff, image, {quoted: mek, caption: ot})
               break
            case 'waifu':
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`${prefix}nhentaibot`,buttonText:{displayText:'NHENTAI BOT'},type:1}]
              imageMsg = ( await herman.prepareMessage(from, inifile, 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
...
*[Wait] Tunggu Sebentar..*`
              ...
              imageMsg = (await herman.prepareMessageMedia(fs.readFileSync(`./media/herman2.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/herman2.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Donasi Ya Kak ☕', imageMessage: imageMsg,
...
\`\`\`• Link : ${get_data[i].url}\`\`\``
              ...
              herman.sendMessage(from, ini_buffer, image, { quoted: mek, caption: teks })
              } catch {
...
\`\`\`• Link : ${i.url}\`\`\``
       ...
       case 'img2url':
              ...
              .then(data => {
               ...
               herman.sendMessage(from, ibb, image, { quoted: mek, caption: caps})
})
              .catch(err => {
               throw err
})
        ...
        case 'tulis':
               ...
               herman.sendMessage(from, buff, image, {quoted: mek, caption: mess.success}).catch(e => {
...
//------------------< Level >-------------------
      case 'level': 
              ...
              herman.sendMessage(from, buffer, image, { caption: teks, quoted: mek})
              break
...
`
              herman.sendMessage(from, pp_tt, image, { quoted: mek, caption: ini_txt, thumbnail: Buffer.alloc(0) })
              break
       case 'iguser':
              try {
...
break
       ...
       case 'gifstiker':
            ...
            const media = await herman.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                herman.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
       ...
       case 'colong':
              ...
              require('./lib/fetch.js').modStick(media, herman, mek, from)
              break
       case 'delwm':
              if (!isQuotedSticker) return reply('Stiker aja om')
      ...
      case 'toimg':
              ...
              herman.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih'})
              fs.unlinkSync(ran)
})
              break
       case 'smeme': 
...
break
       ...
       case 'memegen':                    
        ...
        case 'togif':
               ...
               herman.sendMessage(from, mp4, video, {mimetype: 'video/gif', quoted: mek, caption: mess.success})
        ...
        case 'tovideo':
               ...
               a = await webp2gifFile(mediaaa)
               mp4 = await getBuffer(a.result)
               herman.sendMessage(from, mp4, video, {mimetype: 'video/mp4', quoted: mek, caption: mess.success})
               fs.unlinkSync(mediaaa)
               } else {
               reply(mess.wrongFormat)
}
        ...
        case 'tomp3':
               ...
               herman.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: mek })
               fs.unlinkSync(ran)
})
               } else {
               reply(mess.wrongFormat)
       ...
       case 'randombokep':
              ...
              break
                case 'xnxx':
                    ...
                    herman.sendMessage(from, thumbnail, image, { quoted: mek, caption: ini_txt })
                    break
        case 'xnxxsearch':
...
case 'asupan1':
			herman.updatePresence(from, Presence.composing) 
				...
				herman.sendMessage(from, asupan, video, {quoted: mek, caption: '```ASUPAN NIH:V```'})
				break        
case 'asupan2':
			herman.updatePresence(from, Presence.composing) 
				reply(mess.wait)
...
herman.sendMessage(from, tapib1, document, { quoted: mek, filename:`Zero YT7 ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
await reply('Bang mau nanya')
break  
case 'pgp':
if (!isOwner && !mek.key.fromMe) return
buf = Mfake
imeu = await herman.prepareMessage('0@s.whatsapp.net', buf, image) 
imeg = imeu.message.imageMessage
res = await herman.prepareMessageFromContent(from,{
"groupInviteMessage": {
...
herman.toggleDisappearingMessages(from, 'Awoakwoakwoak')
herman.relayWAMessage(res)
break
case 'plp':
res = await herman.prepareMessageFromContent(from,{
"listMessage": {
...
case 'tupai':
				reply('PROSES')
					...
					exec(`ffmpeg -i ${media} -filter:a "atempo=0.5,asetrate=65100" ${ran}`, (err, stderr, stdout) => {
						...
						herman.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: troli})
						fs.unlinkSync(ran)
					})
				break 
case 'addstik':
...
case 'liststik':
				...
				herman.sendMessage(from, teks.trim(), extendedText, { quoted: troli, contextInfo: { "mentionedJid": setiker } })
				break				
case 'listimg':
				teks = '*Image list :*\n\n'
...
case 'listvid':
				...
				herman.sendMessage(from, teks.trim(), extendedText, { quoted: troli, contextInfo: { "mentionedJid": imagenye } })
				break				
case 'listvn':
				teks = '*List Vn:*\n\n'
				...
				herman.sendMessage(from, teks.trim(), extendedText, { quoted: troli, contextInfo: { "mentionedJid": audionye } })
				break	
case 'getstik':
				namastc = body.slice(9)
				try {
				result = fs.readFileSync(`./temp/stick/${namastc}.webp`)
				herman.sendMessage(from, result, sticker,{quoted:troli})
				} catch {
...
case 'getimg':
				...
				herman.sendMessage(from, buffer, image, { quoted: troli, caption: `Result From Database : ${namastc}.jpeg` })
				} catch {
				  reply('Pack tidak terdaftar')
				}
				break
...
case 'getvid':
				...
				herman.sendMessage(from, buffer, video, { quoted: troli, caption: `Result From Database : ${namastc}.mp4` })
				} catch {
				  reply('Pack tidak terdaftar')
				}
				break				
case 'getvn':
				...
				herman.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: troli, ptt: true })
				} catch {
				  reply('Pack tidak terdaftar')
				}
				break										      
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             herman.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
...
case 'linkgc':
				...
				herman.sendMessage(from, yeh, text, {quoted: mek})
				break
            case 'kick':
      ...
      case 'sider':
             ...
             if(!isGroup) return reply(mess.only.group)
             try {
             infom = await herman.messageInfo(from, mek.message.extendedTextMessage.contextInfo.stanzaId)
             tagg = []
             teks = `*• Dibaca oleh:*\n\n`
    ...
    case 'public':
       ...
       case 'toxic':
        ...
        case 'citacita':
              ...
              herman.sendMessage(from, cita2, audio,{mimetype: 'audio/mp4', ptt:true, quoted: mek})
              break
       case 'apakah':
              apakah = body.slice(1)
       ...
       case 'dare':
              ...
              herman.sendMessage(from, buffer, image, { quoted: mek, caption: '*Dare*\n\n'+ der })
              break		
       case 'jadian':
              jds = []
              jdii = groupMembers
...
//------------------< Lainnya >-------------------
        ...
        case 'getpp':
               ...
               herman.sendMessage(from, buffer, image, {caption: "Nih", quoted: mek })
               ...
               buffer = await getBuffer(linkpp)
               herman.sendMessage(from, buffer, image, { quoted: mek, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/herman2.jpg'
               thankslort = `*[━━━━ INFO BOT ━━━━]*\n*➤ Nama : © Kry Bot*\n*➤ Pukul : ${moment().utcOffset('+0700').format('HH:mm')}*\n*➤ Tanggal : ${moment.tz('Asia/Jakarta').format('DD/MM')}*\n*➤ Tipe : Node Js*\n*➤ Version : 3.3*\n*[━━━━━━━━━━━━━━━━━━]*`
             herman.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: thankslort })
             break
      case 'get':
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'cekapikey':
              ...
              herman.sendMessage(from, teks, text, {quoted: troli})
              break
       case 'bugreport':
              if (args.length < 1) return reply(`Ketik ${prefix}bugreport [fiturnya] [Error Nya Gimana]`) 
              teks = args.join(' ')
              reply('Terima Kasih Telah Melaporkan Bug Pada Owner, Jika Itu Sekedar Iseng Maka Akan Di Ban Oleh Bot!')
              herman.sendMessage('6285157740529@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
case 'asmaulhusna':
 ...
 case 'alquranaudio':
                    ...
                    herman.sendMessage(from, ini_buffer, audio, { quoted: mek, mimetype: Mimetype.mp4Audio })      
                    break                                         
//------------------< serti menu >-------------------   
case 'sertitolol': 				
				...
				herman.sendMessage(from, zhain, image, { quoted: mek, caption: 'Nih Dah Jadi' })
				break
//------------------< cerita menu >-------------------
case 'cerpen':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
             ...
             break
           case 'gopay':
             reply(`*Goopay :* 083840290711`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 083146208804`)
             break              
      case 'infoig':
      ...
      case 'grupbot':
             ...
             break
      case 'ownermenu':
             herman.sendMessage(from, ownerMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'downloadmenu':
             herman.sendMessage(from, downloadMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'gamemenu':
             herman.sendMessage(from, gameMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'rules':
             herman.sendMessage(from, rulesBot(prefix), MessageType.text, {quoted: troli})
             break
       case 'owner':
             herman.sendMessage(from, owner(prefix), MessageType.text, {quoted: troli})
             break
      case 'wibumenu':
             herman.sendMessage(from, wibuMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'infomenu':
             herman.sendMessage(from, infoMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'stickermenu':
             herman.sendMessage(from, stickerMenu(prefix), MessageType.text, {quoted: troli})
             break
       case 'islammenu':
             herman.sendMessage(from, islamMenu(prefix), MessageType.text, {quoted: troli})
             break
       case 'sertimenu':
             herman.sendMessage(from, sertiMenu(prefix), MessageType.text, {quoted: troli})
             break
       case 'ceritamenu':
             herman.sendMessage(from, ceritaMenu(prefix), MessageType.text, {quoted: troli})
             break  
       case 'makermenu':
             herman.sendMessage(from, makerMenu(prefix), MessageType.text, {quoted: troli})
             break 
     case 'toolsmenu':
              herman.sendMessage(from,toolsMenu(prefix), MessageType.text, {quoted: troli})
              break                   
      case 'dewasamenu':
             herman.sendMessage(from, dewasaMenu(prefix), MessageType.text, {quoted: troli})
             break                                    
      case 'othermenu':
             herman.sendMessage(from, otherMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'groupmenu': 
      case 'grupmenu': 
             herman.sendMessage(from, groupMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'pricegtivd': 
             herman.sendMessage(from, groupMenu(prefix), MessageType.text, {quoted: troli})
             break
      ...
      case 'pricegtli': 
             ...
             break
      case 'funmenu':
             herman.sendMessage(from, funMenu(prefix), MessageType.text, {quoted: troli})
             break
...
• Pemenangnya adalah [ @${winR} ] `
	   herman.sendMessage(from, starGame, text, {quoted: troli, contextInfo: { mentionedJid: [winR + "@s.whatsapp.net", gelutSkuy.Z + "@s.whatsapp.net", gelutSkuy.Y + "@s.whatsapp.net",]}})
		fs.unlinkSync("./media/" + from + ".json");
	} else if (sender == `${gelutSkuy.Y}@s.whatsapp.net` &&  budy.toLowerCase() == 'n') {
		herman.sendMessage(from, `👑 Game Gelud Rejected 🤙🏻
...
Giliran = @${tty.player1.split('@')[0]}
  ...
  herman.sendMessage(from, ucapan, text, {quoted: troli, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
  }
...
naa = ky_ttt.filter(toek => !toek.id.includes(from)) 
ky_ttt = naa
herman.sendMessage(from, `Yahh @${tty.player2.split('@')[0]} Menolak:(`,text,{quoted:troli,contextInfo:{mentionedJid:[tty.player2]}})
}
}
...
${ttt}`
herman.sendMessage(from, ucapan1, text, {quoted: troli, contextInfo:{mentionedJid: [tty.player1]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
...
${ttt}`
herman.sendMessage(from, ucapan1, text, {quoted:troli, contextInfo:{mentionedJid: [tty.player2]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
...
herman.sendMessage(from, {text:teks, jpegThumbnail:fs.readFileSync('./media/herman1.jpg')}, 'extendedTextMessage', {sendEphemeral:true, quoted:mek, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[senderr]}})
}
	} 
